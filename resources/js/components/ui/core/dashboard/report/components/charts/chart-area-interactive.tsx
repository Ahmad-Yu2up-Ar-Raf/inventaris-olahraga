...
export function ChartAreaInteractive({ chartData , className, isShowMerchandise = true, title = "Data Chart - Interactive" , deskripcion = "Showing total data Count for the last 3 month", isShowGallery = true  }: ChartAreaInteractiveProps) {
  ...
  return (
          ...
          <AreaChart data={filteredData}>
            <defs>
             ...
             {isShowGallery && (
                    ...
                    <linearGradient id="fillpinjaman" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  stopColor="var(--color-pinjaman)"
                  stopOpacity={0.8}
                />
                <stop
                  offset="95%"
   ...
   {isShowMerchandise && (
<linearGradient id="fillbarang" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  stopColor="var(--color-barang)"
                  stopOpacity={0.8}
                />
                <stop
                  offset="95%"
  ...
  {isShowMerchandise && (
     ...
     {isShowGallery && (
           <Area
              dataKey="pinjaman"
              type="natural"
              fill="url(#fillpinjaman)"
              stroke="var(--color-pinjaman)"
              stackId="a"
            />
     )}
