...
import { AnimatedGroup } from '@/components/ui/fragments/animated-group'
import { cn } from '@/lib/utils'
import {Link} from '@inertiajs/react'
import { InfiniteSlider } from '@/components/ui/fragments/infinite-slider'
import { ProgressiveBlur } from '@/components/ui/fragments/progressive-blur'
        ...
        <div className="flex flex-col gap-10">
          ...
          Premium
            ...
            <div className="flex gap-2 flex-col">
              ...
              <p className="lg:text-lg max-w-xl lg:max-w-lg leading-relaxed tracking-tight text-muted-foreground  text-left">
           ...
           <div className="bg-muted h-96 rounded-md relative md:aspect-video mb-2">
<img 
